    ...
    for i in range(1, len(sys.argv) - 1):
        with open(sys.argv[i]) as f:
            for line in f:
                ...
                ins.append(float(str_list[2]))
#                l2.append(int(str_list[4]))
#                 tlb_data.append(float(str_list[5]))
                l1_dcache.append(int(str_list[3]))
                tlb_ins.append(int(str_list[4]))
                l3.append(int(str_list[5]))
                error.append(float(str_list[6]))
                ans.append(float(str_list[7]))
                outputs.append(float(str_list[8]))
